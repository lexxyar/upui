...
const style = computed((): TStyl => {
  if (props.styl === 'error') return 'danger'
  return props.styl
})
</script>
...
<template>
  ...
  >
    <div
      ...
      <template v-if="style==='danger'">
        <div
            class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-danger-500 bg-danger-100 rounded-lg dark:bg-danger-800 dark:text-danger-200">
          <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
               xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
      ...
      <template v-if="style==='warning'">
        <div
            class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-warning-500 bg-warning-100 rounded-lg dark:bg-warning-700 dark:text-warning-200">
          <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
               xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
